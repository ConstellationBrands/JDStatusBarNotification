Pod::Spec.new do |s|
  ...
  s.homepage     = 'https://github.com/ConstellationBrands/JDStatusBarNotification'
  s.license      = { :type => 'MIT' }
  s.author       = { 'Markus Emrich' => 'markus.emrich@gmail.com' }  
  
  s.source       = { :git => 'https://github.com/ConstellationBrands/JDStatusBarNotification.git', :tag => "#{s.version}" }
